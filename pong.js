...
class Pong{
    constructor(canvas){
        ...
        this._players[0].position.x = 40;
        this._players[1].position.x = this._canvas.width - 40;
    ...
    draw(){
        ...
        this._players.forEach(player => this.drawRectangle(player));
    ...
    update(deltaTime){
        ...
        if(this._players[0].moveUp){
            this._players[0].position.y -= 300 * deltaTime;
        }

        if(this._players[0].moveDown){
            this._players[0].position.y += 300 * deltaTime;
        }

        if(this._players[1].moveUp){
            this._players[1].position.y -= 300 * deltaTime;
        }

        if(this._players[1].moveDown){
            this._players[1].position.y += 300 * deltaTime;
        }
        ...
        this._players[1].position.y = this._ball.position.y;

        this._players.forEach(player => this.collisionDetection(player, this._ball));
...
canvas.addEventListener('mousemove', event => {
    pong._players[0].position.y = event.offsetY;
});

// function startMovePlayer(event){
//     if(event.keyCode === 87 && pong._players[0].moveDown === false){
//         pong._players[0].moveUp = true;
//     } else if(event.keyCode === 83 && pong._players[0].moveUp === false){
//         pong._players[0].moveDown = true;
//     }
